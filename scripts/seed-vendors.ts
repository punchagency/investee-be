...
const vendorData = [
  // General Contractors
  {
    ...
    category: "contractor",
    description:
      "Full-service general contractor specializing in residential renovations and new construction. Over 15 years of experience in the Los Angeles area.",
    phone: "(310) 555-0101",
  ...
  },
  {
    ...
    category: "contractor",
    description:
      "Premier contractor for luxury home renovations and high-end commercial projects. Known for exceptional craftsmanship and attention to detail.",
    phone: "(323) 555-0102",
  ...
  // Home Inspectors
  {
    ...
    category: "inspector",
    description:
      "Certified home inspectors providing comprehensive property inspections for buyers, sellers, and investors. Same-day reports available.",
    phone: "(818) 555-0201",
  ...
  },
  {
    ...
    category: "inspector",
    description:
      "Thorough property inspections with thermal imaging and drone assessments. Specialized in multi-family and commercial properties.",
    phone: "(310) 555-0202",
  ...
  // Appraisers
  {
    ...
    category: "appraiser",
    description:
      "Licensed real estate appraisers providing accurate valuations for residential and commercial properties. FHA and VA approved.",
    phone: "(213) 555-0301",
  ...
  // Real Estate Attorneys
  {
    ...
    category: "attorney",
    description:
      "Real estate attorneys specializing in transactions, disputes, and landlord-tenant law. Experienced with investment properties and 1031 exchanges.",
    phone: "(310) 555-0401",
  ...
  // Title Companies
  {
    ...
    category: "title",
    description:
      "Full-service title and escrow company with locations throughout Los Angeles. Fast closings and excellent customer service.",
    phone: "(323) 555-0501",
  ...
  // Insurance Agents
  {
    ...
    category: "insurance",
    description:
      "Independent insurance agency specializing in property and landlord insurance. Competitive rates for investment properties.",
    phone: "(310) 555-0601",
  ...
  // Property Managers
  {
    ...
    description:
      "Full-service property management for residential and commercial properties. Tenant screening, rent collection, and maintenance coordination.",
    phone: "(323) 555-0701",
  ...
  // Plumbers
  {
    ...
    category: "plumber",
    description:
      "24/7 emergency plumbing services. Specializing in residential repairs, water heater installation, and sewer line replacement.",
    phone: "(818) 555-0801",
  ...
  // Electricians
  {
    ...
    description:
      "Licensed electricians for residential and commercial projects. Panel upgrades, EV charger installation, and smart home wiring.",
    phone: "(310) 555-0901",
  ...
  // HVAC
  {
    ...
    category: "hvac",
    description:
      "Heating, ventilation, and air conditioning installation and repair. Energy-efficient solutions and preventative maintenance programs.",
    phone: "(323) 555-1001",
  ...
  // Roofing
  {
    ...
    category: "roofing",
    description:
      "Complete roofing services including repairs, replacements, and new installations. Experienced with all roofing types.",
    phone: "(818) 555-1101",
  ...
  // Handyman
  {
    ...
    category: "handyman",
    description:
      "Reliable handyman services for all your home repair needs. Drywall, painting, carpentry, and general maintenance.",
    phone: "(213) 555-1201",
  ...
  // Landscaping
  {
    ...
    description:
      "Professional landscaping design and maintenance. Drought-tolerant gardens, hardscaping, and irrigation systems.",
    phone: "(310) 555-1301",
  ...
  // Cleaning Services
  {
    ...
    category: "cleaning",
    description:
      "Professional cleaning for residential and commercial properties. Move-in/move-out cleaning, deep cleaning, and regular maintenance.",
    phone: "(323) 555-1401",
...
async function seedVendors() {
  ...
  try {
    // Clear existing vendors - we assume table exists now via TypeORM sync
    ...
    for (const vendor of vendorData) {
      // TypeORM simple-array stores arrays as comma-separated strings
      const specialtiesStr = vendor.specialties.join(",");
      const serviceAreasStr = vendor.serviceAreas.join(",");

      await client.query(
        `INSERT INTO vendors (
          name, category, description, phone, email, website, city, state,
          rating, review_count, verified, licensed, insured, years_in_business,
          specialties, service_areas, price, availability, contact_name
